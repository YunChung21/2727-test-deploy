...
const Header: React.FC<HeaderProps> = ({
  ...
  //For toggle the hamburger menu
  const toggleHamburger = () => {
    //console.log(hamburgerOpen);
    setHamburgerOpen(!hamburgerOpen);
  };

  //For header changing styles when scroll away from the top.
  useEffect(() => {
  ...
  return (
    <header
      className={` ${scroll ? styles["header-is-sticky"] : ""} ${
        styles.header
      } ${black ? styles.black : ""}`}
    >
      <div
      ...
      >
        ...
        <nav className={styles.header__menu}>
          <ul className={styles.menu__list}>
            <li className={styles.menu__item}>
              <a href={langLink} className={styles.menu__link}>
                {langText}
              </a>
            </li>
            <li className={styles.menu__item}>
              <a href={galleryLink} className={styles.menu__link}>
                {galleryText}
              </a>
            </li>
            <li className={styles.menu__item}>
              <a href={`tel:${phoneLink}`} className={styles.menu__link}>
                {phoneText}
              </a>
            </li>
          </ul>
          <ul className={styles.social__list}>
            <li className={styles.social__item}>
              <a
                href="https://www.instagram.com/2727coworking.atwater/?hl=en"
            ...
            <li className={styles.social__item}>
              <a
                href="https://www.facebook.com/2727coworking"
                className={styles.social__link}
              >
                <svg
                  className={styles.socialIcon}
        ...
        <div className={styles["icon-menu"]} onClick={toggleHamburger}>
          <span></span>
        </div>
      </div>
    </header>
