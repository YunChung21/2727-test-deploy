        ...
        <div className={styles.reviews__container}>
          ...
          <div className={styles.reviews__slider}>
            ...
            >
              ...
              <SwiperSlide className={styles.reviews__box}>
                <p className={styles["reviews__box-text"]}>
                  “2727 coworking has very clean premises, and all members are
                  so friendly and open-minded! Also, very easy to get by using
                  public transport. The facilities were very well maintained,
                  just an overall very accommodating workspace with everything
                  you need! I would highly recommend it!”
                </p>
